<div class="auth-login-screen">
    <div class="auth-login-wrap">
        ...
        <div class="login">
            ...
            <form wire:submit="verify2fa" class="login-form">
                ...
                <p class="meta-line">Open your authenticator app and enter the current code.</p>

                <button type="submit" class="login-submit">Verify 2FA</button>
            </form>
        </div>
    </div>
</div>
