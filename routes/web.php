...
use App\Livewire\Settings\Security\Disable as SettingsSecurityDisable;
use App\Livewire\Settings\Security\Enable as SettingsSecurityEnable;
use App\Livewire\Settings\Security\Index as SettingsSecurityIndex;
use App\Livewire\Settings\Security\Setup as SettingsSecuritySetup;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('settings/security', SettingsSecurityIndex::class)->name('settings.security');
    Route::get('settings/security/2fa/setup', SettingsSecuritySetup::class)->name('settings.security.2fa.setup');
    Route::get('settings/security/2fa/enable', SettingsSecurityEnable::class)->name('settings.security.2fa.enable');
    Route::get('settings/security/2fa/disable', SettingsSecurityDisable::class)->name('settings.security.2fa.disable');
